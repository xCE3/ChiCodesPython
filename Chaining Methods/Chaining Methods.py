...
tim.make_deposit(200).make_deposit(200).make_deposit(50).make_withdrawal(5)
monty.make_deposit(50).make_deposit(50).make_withdrawal(5).make_withdrawal(5)
fred.make_deposit(50).make_withdrawal(5).make_withdrawal(5).make_withdrawal(5)
